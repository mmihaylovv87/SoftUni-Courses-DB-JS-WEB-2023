namespace ADONET
{
    public static class Queries
    {
        ...
        public const string CREATE_DATABASE_MINIONSDB =
            @"CREATE DATABASE MinionsDB";

        public const string CREATE_TABLES_MINIONSDB =
        ...
        public const string INSERT_INTO_TABLES_IN_MINIONSDB =
        ...
        public const string INSERT_VILLAIN =
        ...
        public const string TOWN_NAMES_TO_UPPPERCASE =
            @"UPDATE Towns
                 SET [Name] = UPPER(Name)
        ...
        public const string TOWN_NAME_BY_COUNTRY =
            @" SELECT t.[Name]
                 FROM Towns as t
